...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  <pipe>
    <rasterrenderer opacity="1" alphaBand="0" classificationMax="12" classificationMinMaxOrigin="User" band="1" classificationMin="4" type="singlebandpseudocolor">
      <rasterTransparency/>
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0">
          ...
          <item alpha="255" value="10" label="10.000000" color="#29924a"/>
          <item alpha="255" value="12" label="12.000000" color="#00441b"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
